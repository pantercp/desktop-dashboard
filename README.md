...
<!-- TABLE OF CONTENTS -->
<details>
  <summary>Tableof Contents</summary>
  <ol>
    <li>
...
NinetyNine creates a completely unique desktop wallpaper every day to keep you inspired and is comprised of an inspirational image in the centre, with space to the left to organise your desktop shortcuts and temporary files. On the right side of the image there is a space to be utilised for what I refer to as your personal dashboard.
